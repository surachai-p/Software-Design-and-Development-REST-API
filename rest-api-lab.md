...
```
ผลลัพธ์จะแสดง 
![ผลการรัน Server]![alt text](image.png)
...
![หน้าต่าง Postman]![alt text]![alt text](image-2.png)
...
4. การตั้งค่า Body:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปการตั้งค่า Postman]![alt text](image-2.png)
...
1. การทดสอบ Request:
   ...
   ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล]![alt text](image-1.png)
...
2. การสร้าง Request อื่นๆ:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลทั้งหมด]![alt text](image-3.png)
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลโดยระบุ ID]![alt text](image-4.png)
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการแก้ไขข้อมูล]![alt text](image-5.png)
   ...
   - URL: http://localhost:3000/api/bookings/1
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล]![alt text](image-6.png)
...
![ผลลัพธ์การรัน API Server ด้วย Python]![alt text](image-7.png)
...
2. สร้าง Request สำหรับทดสอบ:
   ...
   ```
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล]![alt text](image-8.png)
   ...
   - 
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูลทั้งหมด]![alt text](image-9.png)
   ...
   - Method: GET
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูล]![alt text](image-10.png)
   ...
   ```
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการแก้ไขข้อมูล]![alt text](image-11.png)
   ...
   - Method: DELETE
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล]![alt text](image-12.png)
