...
> - **Thunder Client** — Extension ใน VS Code ที่ใช้ได้เลยโดยไม่ต้องติดตั้งโปรแกรมเพิ่ม ค้นหาใน Extensions (`Ctrl+Shift+X`) พิมพ์ ")t"
...
2. สร้าง Request สำหรับทดสอบ:
 ...
 ![alt text](image-7.png)
   ...
   - URL: `http://localhost:5000/api/bookings/6`
   - Method: GET
