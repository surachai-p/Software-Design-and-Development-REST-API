...
4. การตั้งค่า Body:
  ...
  ### บันทึกผลการทดลอง
![alt text](<LAB1-Node.js/result-png/การตั้งค่า Postman.png>)
...
1. การทดสอบ Request:
   ...
   ### บันทึกผลการทดลอง
![alt text](LAB1-Node.js/result-png/ผลการเพิ่มข้อมูล.png)
![alt text](LAB1-Node.js/result-png/ผลการเพิ่มข้อมูล2.png)
...
2. การสร้าง Request อื่นๆ:
  ...
  ### บันทึกผลการทดลอง
![alt text](<LAB1-Node.js/result-png/ผลการ Get ข้อมูลทั้งหมด.png>)
  ...
  ### บันทึกผลการทดลอง
![alt text](<LAB1-Node.js/result-png/ผลการ Get ข้อมูลโดยระบุ ID.png>)
  ...
  ### บันทึกผลการทดลอง
![alt text](LAB1-Node.js/result-png/ผลการแก้ไขข้อมูล.png)
...
2. สร้าง Request สำหรับทดสอบ:
   ...
   ```
    ### บันทึกผลการทดลอง
![alt text](LAB2-Python/result-png/py-การเพิ่มข้อมูล.png)
   ...
   - 
    ### บันทึกผลการทดลอง
![alt text](LAB2-Python/result-png/py-ผลการเรียกดูข้อมูล.png)
   ...
   - Method: GET
    ...
    ### บันทึกผลการทดลอง
![alt text](LAB2-Python/result-png/py-ผลการเรียกดูข้อมูล-id.png)
   ...
   ```
    ### บันทึกผลการทดลอง
![alt text](LAB2-Python/result-png/py-ผลการแก้ไขข้อมูล.png)
   ...
   - Method: DELETE
    ...
    ### บันทึกผลการทดลอง
![alt text](LAB2-Python/result-png/py-ผลการลบข้อมูล.png)
