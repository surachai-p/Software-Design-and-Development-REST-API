...
4. การตั้งค่า Body:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปการตั้งค่า Postman](![alt text](<การตั้งค่า Postman.png>))
...
1. การทดสอบ Request:
   ...
   ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล](![alt text](ผลการเพิ่มข้อมูล.png))
...
2. การสร้าง Request อื่นๆ:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลทั้งหมด](![alt text](<ผลการ Get ข้อมูลทั้งหมด.png>))
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลโดยระบุ ID](![alt text](<ผลการ Get ข้อมูลโดยระบุ ID.png>))
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการแก้ไขข้อมูล](![alt text](ผลการแก้ไขข้อมูล.png))
   ...
   - URL: http://localhost:3000/api/bookings/1
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล](![alt text](ผลการลบข้อมูล.png))
...
2. สร้าง Request สำหรับทดสอบ:
  ...
  ![แทรกรูปผลการเพิ่มข้อมูล](![alt text](ผลการเพิ่มข้อมูล...png))
   ...
   - 
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูลทั้งหมด](![alt text](ผลการเรียกข้อมูลทั้งหมด.png))
   ...
   - Method: GET
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูล](![alt text](ผลการเรียกดูข้อมูล.png))
   ...
   ```
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการแก้ไขข้อมูล](![alt text](ผลการแก้ไขข้อมูล1.png))
   ...
   - Method: DELETE
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล](![alt text](ผลการลบข้อมูล1.png))
