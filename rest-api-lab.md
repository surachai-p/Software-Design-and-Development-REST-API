...
4. การตั้งค่า Body:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปการตั้งค่า Postman](\รูปภาพการทดลอง\p1.png)
...
1. การทดสอบ Request:
   ...
   ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล](\รูปภาพการทดลอง\p2.png)
...
2. การสร้าง Request อื่นๆ:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลทั้งหมด](\รูปภาพการทดลอง\p p p.png)
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลโดยระบุ ID](\รูปภาพการทดลอง\Get Booking by ID.png)
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการแก้ไขข้อมูล](\รูปภาพการทดลอง\Get Booking by ID.png)
   ...
   - URL: http://localhost:3000/api/bookings/1
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล](\รูปภาพการทดลอง\Delete Booking.png)
...
2. สร้าง Request สำหรับทดสอบ:
   ...
   ```
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล](\รูปภาพการทดลอง\Hotel Booking API - Python.png)
   ...
   - 
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูลทั้งหมด](\รูปภาพการทดลอง\py all.png)
  ...
  (\รูปภาพการทดลอง\py-id-01.png)(\รูปภาพการทดลอง\py-id-02.png)(\รูปภาพการทดลอง\py-id-03.png)
   ...
   ```
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการแก้ไขข้อมูล](\รูปภาพการทดลอง\put-py-1.png)
   ...
   - Method: DELETE
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล](\รูปภาพการทดลอง\put-py-1.png)
