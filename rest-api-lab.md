...
4. การตั้งค่า Body:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปการตั้งค่า Postman](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 14.15.31.png>))
...
1. การทดสอบ Request:
   ...
   ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 14.50.34.png>))
...
2. การสร้าง Request อื่นๆ:
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลทั้งหมด](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 14.55.44.png>))
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการ Get ข้อมูลโดยระบุ ID](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 14.57.55.png>))
  ...
  ### บันทึกผลการทดลอง
  ![แทรกรูปผลการแก้ไขข้อมูล](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 15.02.50.png>))
   ...
   - URL: http://localhost:3000/api/bookings/1
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 15.06.10.png>))
...
2. สร้าง Request สำหรับทดสอบ:
   ...
   ```
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 15.31.25.png>))
   ...
   - 
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูลทั้งหมด](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 15.34.03.png>))
   ...
   - Method: GET
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูล](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 15.38.02.png>))
  ...
  ![แทรกรูปผลการแก้ไขข้อมูล](path/to/your/image.png)
   ...
   - Method: DELETE
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการลบข้อมูล](![alt text](<ภาพถ่ายหน้าจอ 2569-02-26 เวลา 15.42.27.png>))
