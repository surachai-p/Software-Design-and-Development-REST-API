...
![![alt text](image-7.png)](./images/runPythonApp.png)
...
2. สร้าง Request สำหรับทดสอบ:
   ...
   ```
    ### บันทึกผลการทดลอง
  ![![alt text](image-8.png)](path/to/your/image.png)
   ...
   - 
    ### บันทึกผลการทดลอง
  ![![alt text](image-9.png)  ![alt text](image-10.png)](path/to/your/image.png)
