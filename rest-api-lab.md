...
```
ผลลัพธ์จะแสดง 
![ผลการรัน Server](![alt text](image-3.png))
...
1. การทดสอบ Request:
   ...
   ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล](![alt text](image-1.png)![alt text](image-2.png))
...
2. สร้าง Request สำหรับทดสอบ:
  ...
  ![แทรกรูปผลการเพิ่มข้อมูล](![alt text](image-8.png))
   ...
   - 
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูลทั้งหมด](![alt text](image-9.png)![alt text](image-10.png))
   ...
   - Method: GET
    ...
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเรียกดูข้อมูล](![alt text](image-11.png))
