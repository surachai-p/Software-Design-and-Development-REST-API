...
```
ผลลัพธ์จะแสดง 
![ผลการรัน Server]![alt text](image-1.png)
...
![ผลลัพธ์การรัน API Server ด้วย Python](./images/runPythonApp.png)![alt text](image-9.png)
...
2. สร้าง Request สำหรับทดสอบ:
   ...
   ```
    ### บันทึกผลการทดลอง
  ![แทรกรูปผลการเพิ่มข้อมูล]![alt text](image-10.png)
