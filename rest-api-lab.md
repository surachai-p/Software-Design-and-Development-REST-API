...
4. การตั้งค่า Body:
  ...
  ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/1.png](images/1.png)
...
1. การทดสอบ Request:
   ...
   ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/5.png](images/5.png)
  ![Software-Design-and-Development-REST-API/images/6.png](images/6.png)
...
2. การสร้าง Request อื่นๆ:
  ...
  ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/2.png](images/2.png)
  ...
  ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/3.png](images/3.png)
  ...
  ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/4.png](images/4.png)
   ...
   - URL: http://localhost:3000/api/bookings/1
    ...
    ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/7.png](images/7.png)
...
2. สร้าง Request สำหรับทดสอบ:
   ...
   ```
    ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/2-2.png](images/2-2.png)
  ![Software-Design-and-Development-REST-API/images/2-3.png](images/2-3.png)
  ![Software-Design-and-Development-REST-API/images/2-4.png](images/2-4.png)
   ...
   - 
    ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/2-1.png](images/2-1.png)
   ...
   - Method: GET
    ...
    ### บันทึกผลการทดลอง
   ![Software-Design-and-Development-REST-API/images/2-5.png](images/2-5.png)
   ...
   ```
    ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/2-6.png](images/2-6.png)
   ...
   - Method: DELETE
    ...
    ### บันทึกผลการทดลอง
  ![Software-Design-and-Development-REST-API/images/2-7.png](images/2-7.png)
